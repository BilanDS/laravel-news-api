...
use App\Http\Controllers\Api\Dashboard\NewsController as ApiDashboardNewsController;
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::apiResource('dashboard/news', ApiDashboardNewsController::class)
        ->names('api.dashboard.news');
});
